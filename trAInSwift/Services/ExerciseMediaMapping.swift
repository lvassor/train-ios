...
struct ExerciseMedia {
    ...
    init(videoGuid: String, note: String? = nil) {
        self.guid = videoGuid
    ...
    init(imageFilename: String, note: String? = nil) {
        self.guid = nil
...
struct ExerciseMediaMapping {
    ...
    static let mapping: [String: ExerciseMedia] = [
        "EX001": ExerciseMedia(videoGuid: "b9c5e583-fec9-492c-a862-b7969692eccf", note: "Uses bodyweight back extension video"),
        "EX002": ExerciseMedia(videoGuid: "b9c5e583-fec9-492c-a862-b7969692eccf", note: "Uses bodyweight back extension video"),
        "EX003": ExerciseMedia(imageFilename: "88951101-45-degrees-Back-Extension-Scapular-Adduction-(male)_Back_max.png"),
        ...
        "EX007": ExerciseMedia(videoGuid: "60ef27d7-5909-429a-a2c1-305cca4eaaf3"),
        "EX008": ExerciseMedia(videoGuid: "44062881-bbc7-4e41-b9db-a8c4f2f55333"),
        "EX009": ExerciseMedia(videoGuid: "19e4d5db-875f-4d02-af02-17512c726e54", note: "Uses pin-loaded variation"),
        "EX010": ExerciseMedia(videoGuid: "adc5f995-c78b-4f27-83b0-3ba33b15c5a5", note: "Uses plate-loaded variation"),
        "EX011": ExerciseMedia(videoGuid: "19e4d5db-875f-4d02-af02-17512c726e54", note: "Uses pin-loaded variation"),
        "EX012": ExerciseMedia(videoGuid: "adc5f995-c78b-4f27-83b0-3ba33b15c5a5", note: "Uses plate-loaded variation"),
        ...
        "EX016": ExerciseMedia(videoGuid: "4b1f1e7a-2e46-4871-9786-1c5c816d3b16", note: "Unavailable"),
        "EX017": ExerciseMedia(videoGuid: "cd95ff49-3c92-4012-b09b-d49d283422c7", note: "Uses plate-loaded variation"),
        "EX018": ExerciseMedia(videoGuid: "cd95ff49-3c92-4012-b09b-d49d283422c7", note: "Uses plate-loaded variation"),
        ...
        "EX024": ExerciseMedia(videoGuid: "aa4f2e1d-31d5-4c18-a021-d719abb85ea1"),
        ...
        "EX031": ExerciseMedia(imageFilename: "51591101-Plank-on-Hands_Waist_max.png"),
        "EX032": ExerciseMedia(imageFilename: "07151101-Side-Plank-(male)_Waist-FIX_max.png"),
        "EX033": ExerciseMedia(videoGuid: "f8be8487-5a9b-4d30-9f47-c28d63ab693d", note: "Uses kneeling variation"),
        ...
        "EX040": ExerciseMedia(videoGuid: "4eaf1007-6b4c-4acd-ba1f-2c7204d4169c", note: "Uses dumbbell variation"),
        "EX041": ExerciseMedia(videoGuid: "4eaf1007-6b4c-4acd-ba1f-2c7204d4169c", note: "Uses dumbbell Farmer's Walk video"),
        ...
        "EX055": ExerciseMedia(videoGuid: "0377a64a-ec30-46d4-bab9-8864c41eeace", note: "Uses Side Plank Hip Adduction (bent knee)"),
        "EX056": ExerciseMedia(videoGuid: "aba6d56e-3f0e-4024-84a6-0814072a6b2b", note: "Uses Side Plank Hip Adduction"),
        ...
        "EX059": ExerciseMedia(videoGuid: "7319581d-ee53-4c4b-aa26-26a6cd9d8eb5"),
        "EX060": ExerciseMedia(videoGuid: "6fbefd4c-ad4a-440d-a190-b9e17889950d"),
        "EX061": ExerciseMedia(videoGuid: "53c0ebde-447c-498f-9c1b-e1093f5334e4"),
        "EX062": ExerciseMedia(videoGuid: "19e7e59e-d94c-4ec4-a047-0ef12221169e"),
        "EX063": ExerciseMedia(imageFilename: "60011101-Single-Straight-Leg-Glute-Bridge-Hold-(left)-(female)_Hips_max.png", note: "Uses dynamic single leg bridge video"),
        "EX064": ExerciseMedia(videoGuid: "37c261f8-7577-4391-88c1-3da51b7042a3"),
        ...
        "EX069": ExerciseMedia(videoGuid: "b86d513e-26f5-4d52-954e-c1735e17b49e", note: "Unavailable"),
        "EX070": ExerciseMedia(videoGuid: "5d389d69-3a8f-4fa7-ace7-9c795e2aefd2"),
        "EX071": ExerciseMedia(videoGuid: "1d7761e7-7b3a-4b7b-860b-7363a62d6b86"),
        "EX072": ExerciseMedia(videoGuid: "1d7761e7-7b3a-4b7b-860b-7363a62d6b86"),
        "EX073": ExerciseMedia(videoGuid: "0388633b-9dfb-44e2-b544-3adaadcf6912"),
        "EX074": ExerciseMedia(videoGuid: "0388633b-9dfb-44e2-b544-3adaadcf6912"),
        ...
        "EX078": ExerciseMedia(videoGuid: "36d73934-becf-49b1-80fc-a0fdb1010cf5", note: "Unavailable"),
        ...
        "EX081": ExerciseMedia(videoGuid: "f847fd56-7b94-45ef-b61f-be1dbdc3afa5", note: "Uses standard reverse lunge video"),
        "EX082": ExerciseMedia(videoGuid: "7d77b8df-f4b6-4a16-b074-37d0bce9b68a", note: "Uses kettlebell reverse lunge video"),
        "EX083": ExerciseMedia(videoGuid: "2b7a679a-702e-457e-b99b-a96b8605f567"),
        "EX084": ExerciseMedia(videoGuid: "3c450656-f47f-4821-9bf6-be90b6e64c1e"),
        ...
        "EX088": ExerciseMedia(videoGuid: "5d57dec1-cfe2-4a22-a7ef-ad3c532d1339"),
        ...
        "EX092": ExerciseMedia(videoGuid: "6aac3f03-dc8a-4078-8a2a-d77b4cef6475", note: "Unavailable"),
        ...
        "EX096": ExerciseMedia(videoGuid: "27a96f06-e9dc-4b09-86b3-c07fded2e114"),
        ...
        "EX107": ExerciseMedia(videoGuid: "bc83e76a-3df4-4565-973c-5582f8b5a798"),
        ...
        "EX113": ExerciseMedia(videoGuid: "217567ba-c8f3-4582-9e49-f385b107848e", note: "Unavailable"),
        "EX114": ExerciseMedia(videoGuid: "217567ba-c8f3-4582-9e49-f385b107848e"),
        "EX115": ExerciseMedia(videoGuid: "217567ba-c8f3-4582-9e49-f385b107848e", note: "Unavailable"),
        ...
        "EX119": ExerciseMedia(videoGuid: "9fb75c65-45e4-4771-9f25-0891cab2f635"),
        "EX120": ExerciseMedia(videoGuid: "e2df47b4-25cd-429f-873a-26aee9084785", note: "Unavailable"),
        ...
        "EX128": ExerciseMedia(videoGuid: "fdddbe22-19cb-47bc-85d2-28ad737c3e4f"),
        ...
        "EX134": ExerciseMedia(videoGuid: "c8a0903a-e1b1-4784-87fb-241850d576c9"),
        "EX135": ExerciseMedia(videoGuid: "aec55232-cf30-4a50-9c1a-c4ac9e5388c7"),
        ...
        "EX140": ExerciseMedia(videoGuid: "3306a9ab-a7df-468a-90c0-149379525554"),
    ]
