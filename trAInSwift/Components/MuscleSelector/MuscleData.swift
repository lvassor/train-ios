...
struct BodyDataProvider {
    ...
    static let maleFront: [MusclePart] = [
        // Chest
        MusclePart(
            slug: .chest,
            paths: MusclePaths(
    ...
    static let maleBack: [MusclePart] = [
        // Neck (removed off-center left portion that was visible in rear view)
        MusclePart(
            slug: .neck,
            paths: MusclePaths(
                right: [
    ...
    // MARK: - Female Front Body

    static let femaleFront: [MusclePart] = [
        // Neck
        MusclePart(
            slug: .neck,
            paths: MusclePaths(
    ...
    // MARK: - Female Back Body

    static let femaleBack: [MusclePart] = [
        // Hair
        MusclePart(
            slug: .hair,
            paths: MusclePaths(
